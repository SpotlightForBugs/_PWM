 ...
 *
 * <p>Generische Klasse BinarySearchTree<ContentType>
 *
 * <p>Mithilfe der generischen Klasse BinarySearchTree koennen beliebig viele Objekte in einem
 * Binaerbaum (binaerer Suchbaum) entsprechend einer Ordnungsrelation verwaltet werden. <br>
 * Ein Objekt der Klasse stellt entweder einen leeren binaeren Suchbaum dar oder verwaltet ein
 * Inhaltsobjekt sowie einen linken und einen rechten Teilbaum, die ebenfalls Objekte der Klasse
 * BinarySearchTree sind.<br>
 * Die Klasse der Objekte, die in dem Suchbaum verwaltet werden sollen, muss das generische
 * Interface ComparableContent implementieren. Dabei muss durch Ueberschreiben der drei
 * Vergleichsmethoden isLess, isEqual, isGreater (s. Dokumentation des Interfaces) eine eindeutige
 * Ordnungsrelation festgelegt sein. <br>
 * Alle Objekte im linken Teilbaum sind kleiner als das Inhaltsobjekt des binaeren Suchbaums. Alle
 * Objekte im rechten Teilbaum sind groesser als das Inhaltsobjekt des binaeren Suchbaums. Diese
 * Bedingung gilt (rekursiv) auch in beiden Teilbaeumen. <br>
...
public class BinarySearchTree<ContentType extends ComparableContent<ContentType>> {
   ...
   * nicht-leerer Baum jedoch immer eine nicht-null-Wurzel sowie nicht-null-Teilbaeume hat.
   */
  ...
  /**
   * Diese Anfrage liefert den Wahrheitswert true, wenn der Suchbaum leer ist, sonst liefert sie den
   * Wert false.
   *
   ...
   * Falls ein bezueglich der verwendeten Vergleichsmethode isEqual mit pContent uebereinstimmendes
   * Objekt im geordneten binaeren Suchbau enthalten ist, passiert nichts. <br>
   * Achtung: hier wird davon ausgegangen, dass isEqual genau dann true liefert, wenn isLess und
   * isGreater false liefern. <br>
   * Andernfalls (isLess oder isGreater) wird das Objekt pContent entsprechend der vorgegebenen
   * Ordnungsrelation in den BinarySearchTree eingeordnet.
   *
   ...
   *
   * @return den linken Teilbaum (Objekt vom Typ BinarySearchTree<ContentType>) bzw. null, wenn der
   *     Suchbaum leer ist
   */
  ...
  /**
   * Diese Anfrage liefert das Inhaltsobjekt des Suchbaumes. Wenn der Suchbaum leer ist, wird null
   * zurueckgegeben.
   *
   * @return das Inhaltsobjekt vom Typ ContentType bzw. null, wenn der aktuelle Suchbaum leer ist
   */
   ...
   * Wenn er leer ist, wird null zurueckgegeben.
   *
   * @return den rechten Teilbaum (Objekt vom Typ BinarySearchTree<ContentType>) bzw. null, wenn der
   *     aktuelle Suchbaum leer ist
   */
  ...
  /**
   * Falls ein bezueglich der verwendeten Vergleichsmethode mit pContent uebereinstimmendes Objekt
   * im binaeren Suchbaum enthalten ist, wird dieses entfernt. Falls der Parameter null ist, aendert
   * sich nichts.
   *
  ...
  /**
   * Falls ein bezueglich der verwendeten Vergleichsmethode isEqual mit pContent uebereinstimmendes
   * Objekt im binaeren Suchbaum enthalten ist, liefert die Anfrage dieses, ansonsten wird null
   * zurueckgegeben. <br>
  ...
  /**
   * Die Methode liefert denjenigen Baum, dessen linker Nachfolger keinen linken Nachfolger mehr
   * hat. Es ist also spaeter moeglich, in einem Baum im rechten Nachfolger den Vorgaenger des
   * linkesten Nachfolgers zu finden.
   */
