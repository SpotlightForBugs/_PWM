public class PWM {
  ...
  public List<Account> getAccounts() {
    ...
    // recursively traverse the tree and add each account to the array, using an overloaded method
    // getAccounts
  ...
  public boolean login(String pAccountName, String pMasterPassword) {
    ...
    return this.accounts.search(account) != null
        && this.accounts.search(account).isCorrectPassword(pMasterPassword);
  }
